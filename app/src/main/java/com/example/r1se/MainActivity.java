...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SERVER_URL = "http://192.168.1.8/R1SE_CRUD/create.php"; // Assuming your server is running locally
    private static final String UPDATE_URL = "http://192.168.1.8/R1SE_CRUD/update.php"; // Assuming your server is running locally
    private static final String DELETE_URL = "http://192.168.1.8/R1SE_CRUD/delete.php"; // Assuming your server is running locally
